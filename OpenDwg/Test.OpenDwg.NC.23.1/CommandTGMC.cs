...
namespace dRz.Test.OpenDwg
{
    public partial class CommandTGMC
    {
        ...
        /// <summary>
        /// смесь армяна с делаваром<br/>
        /// открытие файлов в цикле в Тайге корявый переброс в мультикад<br/>
        /// на некоторых файлах в нано в мультикад прилетает null<br/>
        /// в АК проверил на файлах которые не смог открыть нана, все ок, полный тест не делал, незачем<br/>
        /// нк 4к файлов Total 4000, Read 0, Err 6: time 00:06:43.1897441, 6 ошибок в мультикад нулл<br/>
        /// </summary>
        [CommandMethod("тдтм")]
