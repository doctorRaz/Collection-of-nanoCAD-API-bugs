...
## Открытие файлов чертежей не в графическом редакторе средствами `Multicad`, `AutoCAD 2025` vs `nanoCAD 26` ( *Teigha*)
...
- утечки памяти (>3000 файлов nanoCAD 26 вешает систему, затем падает сам)
...
т.е. nanoCAD обыграл оригинал в Teigha на чужом поле и вчистую слил на своем в Multicad.
